...
import { dbStageToKanban, resolveDbJobKanbanStage } from "@/lib/pipeline-kanban-stage";
...
/** Active pipeline stages (excludes closed/rejected). */
export function isActivePipelineDbStage(stage: string): boolean {
  return dbStageToKanban(stage) !== "closed";
}
