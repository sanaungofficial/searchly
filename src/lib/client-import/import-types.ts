/** Types exposed in the client import UI. */
export type VisibleImportType = "job_tracker" | "target_companies" | "contacts" | "application_info";
...
/** Import type picker shown in UnifiedImportModal step 0. */
export const VISIBLE_IMPORT_TYPE_CONFIGS: ImportTypeConfig[] = [
  ...
  },
  {
    id: "contacts",
    label: "Contacts list",
    description: "Outreach contacts with email — map columns and fold Date, LinkedIn, and Gmail status into notes.",
    accept: ".xlsx,.xls,.csv,.txt",
    pastePlaceholder: "Paste contact rows — include Email, Contact Name, and Company columns.",
    supportsFile: true,
    supportsPaste: true,
    usesAi: false,
  },
