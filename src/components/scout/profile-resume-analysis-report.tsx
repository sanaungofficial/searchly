        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "20px" }}>
          {loading ? (
            ...
            <div style={{ padding: 20, textAlign: "center" }}>
              ...
              <button type="button" onClick={onRefresh} style={{ padding: "8px 16px", background: JR.green, color: JR.gold, border: "none", borderRadius: "var(--scout-radius)", cursor: "pointer" }}>
                Retry analysis
              </button>
            </div>
          ) : report ? (
            <>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 16 }}>
                ...
                <div>
                  <span style={{ display: "inline-block", padding: "3px 10px", background: "#FEF3C7", color: "#92400E", borderRadius: "var(--scout-radius)", fontSize: 11, fontWeight: 700, letterSpacing: 0.5 }}>
                    {report.gradeLabel}
                  </span>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: 20 }}>
                {[
                  ...
                  <div key={box.label} style={{ background: box.bg, borderRadius: "var(--scout-radius)", padding: "12px 8px", textAlign: "center" }}>
              ...
              {aiUnavailable && report.issues.length > 0 && (
                <p style={{ fontSize: 12, color: JR.muted, margin: "0 0 12px", padding: "10px 12px", background: JR.bg, borderRadius: "var(--scout-radius)" }}>
...
export function GradeBadgeRow({
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
      ...
      <div>
        <span style={{ display: "inline-block", padding: "3px 10px", background: "#FEF3C7", color: "#92400E", borderRadius: "var(--scout-radius)", fontSize: 11, fontWeight: 700 }}>
          {label}
        </span>
        <button
          type="button"
