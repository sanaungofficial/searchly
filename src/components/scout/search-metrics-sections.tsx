        ...
        <>
          ...
          >
            {(
              ...
              <MetricCard key={label} label={label} value={count} hint="In your pipeline now" isMobile={isMobile} />
            ))}
          </div>
      ...
      {rel ? (
        <>
          ...
          >
            ...
            <MetricCard label="Meeting scheduled" value={rel.meetingScheduled} isMobile={isMobile} />
          </div>
