        ...
        >
          ...
          {addJobLoading && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 10 }}>
              ...
              />
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#1A3A2F" }}>
          ...
          {addJobError && (
            ...
            >
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, color: "#C4574A" }}>
                {addJobError}
              </p>
            </div>
          )}
          ...
          {jobAnalysis && (
            <div style={{ padding: "20px 0 0", animation: "fadeIn 0.3s ease both" }}>
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 12, marginBottom: 14, flexWrap: "wrap" }}>
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6, flexWrap: "wrap" }}>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 20, fontWeight: 600, color: "#1A1A1A" }}>
                      {jobAnalysis.company ?? "Unknown company"}
                    </p>
                    {jobAnalysis.role && (
                      <>
                        <span style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#52493F" }}>·</span>
                        <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#52493F" }}>{jobAnalysis.role}</p>
                      </>
                    )}
                  </div>
                  <div style={{ display: "flex", gap: 7, flexWrap: "wrap" }}>
                    {jobAnalysis.location && (
                      <span style={{ padding: "3px 10px", background: "rgba(0,0,0,0.05)", borderRadius: 100, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#52493F" }}>
                        📍 {jobAnalysis.location}
                      </span>
                    )}
                    {jobAnalysis.salary && (
                      <span style={{ padding: "3px 10px", background: "rgba(74,139,106,0.1)", borderRadius: 100, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 500, color: "#2D6B4A" }}>
                        {jobAnalysis.salary}
                      </span>
                    )}
                  </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: jobAnalysis.description && jobAnalysis.requirements.length > 0 ? "1fr 1fr" : "1fr", gap: 14, marginBottom: 14 }}>
                {jobAnalysis.description && (
                  <div style={{ background: "#FFFFFF", borderRadius: 7, padding: "14px 16px", border: "1px solid rgba(0,0,0,0.06)" }}>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#A09890", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 8 }}>
                      Role Summary
                    </p>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#2A2218", lineHeight: 1.65, textWrap: "pretty" }}>
                      {jobAnalysis.description}
                    </p>
                  </div>
                )}
                {jobAnalysis.requirements.length > 0 && (
                  <div style={{ background: "#FFFFFF", borderRadius: 7, padding: "14px 16px", border: "1px solid rgba(0,0,0,0.06)" }}>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#A09890", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 10 }}>
                      Key Requirements
                    </p>
                    <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                      {jobAnalysis.requirements.map((r: string, i: number) => (
                        <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 7 }}>
                          <span style={{ color: "#4A8B6A", fontSize: 16, flexShrink: 0, marginTop: 1 }}>✓</span>
                          <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#2A2218", lineHeight: 1.5 }}>{r}</p>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                <button
                  onClick={addToKanban}
                  style={{ padding: "10px 22px", background: "#1A3A2F", color: "#E8D5A3", border: "none", borderRadius: 7, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 600, cursor: "pointer" }}
                >
                  + Add to pipeline
                </button>
                <button
                  onClick={dismissJobAnalysis}
                  style={{ padding: "10px 16px", background: "transparent", color: "#A09890", border: "none", fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, cursor: "pointer" }}
                >
                  Dismiss
                </button>
              </div>
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10 }}>
        <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 600, color: "#1A1A1A" }}>
          Upload CSV — bulk add jobs
        </p>
        {!loading && (
          <button
            onClick={onClose}
            style={{ background: "none", border: "none", cursor: "pointer", fontSize: 20, color: "#A09890", padding: 0, lineHeight: 1 }}
          >
            ×
          </button>
        )}
      ...
      {loading ? (
        ...
        <>
          <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.55, marginBottom: 10, maxWidth: 520 }}>
            Upload a CSV file with job URLs. One URL per line, or columns: <code style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 16, background: "rgba(0,0,0,0.05)", padding: "1px 5px", borderRadius: 7 }}>url,company,role</code>
          </p>
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            <button
            ...
            />
            <span style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#A09890" }}>
              .csv or .txt
            </span>
          </div>
          <div
          ...
          >
            <p style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 16, color: "#A09890", textTransform: "uppercase", letterSpacing: "0.8px", marginBottom: 5 }}>
              Example CSV
            </p>
            <pre style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 16, color: "#52493F", lineHeight: 1.6, margin: 0, whiteSpace: "pre-wrap" }}>
{`url,company,role
    ...
    >
      ...
      {loading && (
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#1A3A2F" }}>Kimchi is analyzing this listing…</p>
        </div>
      )}
      {error && !loading && (
        <div style={{ padding: "8px 12px", background: "rgba(196,87,74,0.06)", borderRadius: 7, border: "1px solid rgba(196,87,74,0.15)", maxWidth: 560 }}>
          <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, color: "#C4574A" }}>{error}</p>
        </div>
      )}
      {analysis && !loading && (
        <div
        ...
        >
          <div style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: 10, flexWrap: "wrap" }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4, flexWrap: "wrap" }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 20, fontWeight: 600, color: "#1A1A1A" }}>{analysis.company ?? "Unknown company"}</p>
                {analysis.role && (
                  <>
                    <span style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#52493F" }}>·</span>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, color: "#52493F" }}>{analysis.role}</p>
                  </>
                )}
              </div>
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                {analysis.location && (
                  <span style={{ padding: "2px 8px", background: "rgba(0,0,0,0.05)", borderRadius: 100, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#52493F" }}>
                    📍 {analysis.location}
                  </span>
                )}
                {analysis.salary && (
                  <span style={{ padding: "2px 8px", background: "rgba(74,139,106,0.1)", borderRadius: 100, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 500, color: "#2D6B4A" }}>
                    {analysis.salary}
                  </span>
                )}
              </div>
          ...
          {analysis.description && (
            <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#2A2218", lineHeight: 1.6, marginBottom: 10, textWrap: "pretty" }}>
              {analysis.description}
            </p>
          )}
          <button
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 20, flexWrap: "wrap" }}>
        {filterChips.map(([id, label]) => {
          ...
          return (
            ...
            >
              {label}
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 16, opacity: 0.7 }}>{count}</span>
            </button>
          );
        })}
      </div>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12, gap: 12 }}>
                  ...
                  >
                    ...
                    >
                      <span style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#E8D5A3" }}>
                        {c.initials}
                      </span>
                    </div>
                    <div style={{ minWidth: 0 }}>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 20, fontWeight: 600, color: "#1A1A1A", marginBottom: 2 }}>
                        {c.role}
                      </p>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, color: "#7A7268" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 4 }}>
                      <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 24, fontWeight: 500, color: fitColor }}>
                        {c.fit}%
                      </span>
                      <span style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#A09890" }}>fit</span>
                    </div>
      ...
      >
        ...
        <div style={{ padding: "20px 24px 18px", borderBottom: "1px solid rgba(0,0,0,0.07)", background: "#FFFFFF" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
            ...
            {card.fit > 0 && (
              <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 16, fontWeight: 500, color: fitColor }}>
                {card.fit}% fit
              </span>
            )}
            ...
            {cardUrl && (
              <a href={cardUrl} target="_blank" rel="noopener noreferrer" style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#4A8B6A", textDecoration: "none", marginLeft: "auto" }}>
                View posting →
              </a>
            )}
          </div>
          {dbId && (
            <button
              ...
              style={{ marginTop: 10, background: "none", border: "none", cursor: "pointer", fontSize: 16, color: "#C4574A", fontFamily: "var(--font-dm-sans), system-ui", padding: 0, textAlign: "left" }}
            >
              Remove job
            </button>
          )}
        ...
        <div style={{ padding: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 20 }}>
            ...
            >
              ...
              <span style={{ flex: 1 }}>
                Update resume
                <span style={{ display: "block", fontSize: 16, fontWeight: 300, opacity: 0.7 }}>Maximize your interview chances</span>
              </span>
              <span style={{ fontSize: 18, opacity: 0.5 }}>{tool === "resume" ? "▲" : "›"}</span>
            </button>
            <button
            ...
            >
              ...
              <span style={{ flex: 1 }}>
                Create cover letter
                <span style={{ display: "block", fontSize: 16, fontWeight: 300, opacity: 0.7 }}>Make your application stand out</span>
              </span>
              <span style={{ fontSize: 18, opacity: 0.5 }}>{tool === "cover" ? "▲" : "›"}</span>
            </button>
            <button
            ...
            >
              ...
              <span style={{ flex: 1 }}>
                ...
                <span style={{ display: "block", fontSize: 16, fontWeight: 300, opacity: 0.7 }}>Understand your strengths & gaps</span>
              </span>
              <span style={{ fontSize: 18, opacity: 0.5 }}>{tool === "fit" ? "▲" : "›"}</span>
            </button>
            {dbId && (
              <button
              ...
              >
                ...
                <span style={{ flex: 1 }}>
                  Tailored resume
                  <span style={{ display: "block", fontSize: 16, fontWeight: 300, opacity: 0.7 }}>AI-tailored full resume for this role</span>
                </span>
          ...
          {tool !== null && !job && (
            <div style={{ padding: "16px", background: "#FFFFFF", borderRadius: 7, border: "1px solid rgba(0,0,0,0.07)", animation: "fadeIn 0.3s ease both", marginBottom: 14 }}>
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 600, color: "#1A1A1A", marginBottom: 6 }}>
                {tool === "resume" ? "Resume tailoring" : tool === "cover" ? "Cover letter" : "Fit analysis"} — coming soon
              </p>
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.6 }}>
          ...
          {tool === "resume" && job && (
            <div style={{ animation: "fadeIn 0.3s ease both" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#1A3A2F", textTransform: "uppercase", letterSpacing: "1px" }}>Updated resume bullets</p>
                <button
                  onClick={() => { if (navigator.clipboard) navigator.clipboard.writeText(job.bullets.map(b => "• " + b.tailored).join("\n\n")); setCopied(true); window.setTimeout(() => setCopied(false), 2000); }}
                  style={{ padding: "4px 10px", background: copied ? "rgba(74,139,106,0.1)" : "#1A3A2F", color: copied ? "#4A8B6A" : "#E8D5A3", border: "none", borderRadius: 7, fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, cursor: "pointer" }}
                >
                  {copied ? "Copied ✓" : "Copy all"}
                </button>
              </div>
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.55, marginBottom: 14, textWrap: "pretty" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 16 }}>
                {job.bullets.map((b, i) => (
                  <div key={i} style={{ padding: "12px 14px", background: "#FFFFFF", borderRadius: 7, borderLeft: "3px solid #1A3A2F" }}>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 400, color: "#1A1A1A", lineHeight: 1.6, marginBottom: 8, textWrap: "pretty" }}>
                      {b.tailored}
                    </p>
                    <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, color: "#A09890", fontStyle: "italic" }}>
                      Original: {b.original}
                    </p>
                  </div>
                ))}
              ...
              <div style={{ padding: "14px", background: "rgba(196,168,106,0.08)", borderRadius: 7, borderLeft: "2px solid #C4A86A" }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#7A6020", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 6 }}>Suggested summary line</p>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 300, color: "#2A2218", lineHeight: 1.6, fontStyle: "italic", textWrap: "pretty" }}>
          ...
          {tool === "cover" && job && (
            <div style={{ animation: "fadeIn 0.3s ease both" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#1A3A2F", textTransform: "uppercase", letterSpacing: "1px" }}>Cover letter</p>
                <button
              ...
              <div style={{ padding: "16px", background: "#FFFFFF", borderRadius: 7, borderLeft: "3px solid #1A3A2F" }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 300, color: "#1A1A1A", lineHeight: 1.75, whiteSpace: "pre-wrap", textWrap: "pretty" }}>
                  {job.coverLetter}
                </p>
              </div>
            </div>
          ...
          {tool === "fit" && job && (
            <div style={{ animation: "fadeIn 0.3s ease both" }}>
              <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#1A3A2F", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 12 }}>Fit analysis</p>
              ...
              <div style={{ padding: "16px", background: "#FFFFFF", borderRadius: 7, marginBottom: 14, display: "flex", alignItems: "center", gap: 16 }}>
                <div style={{ position: "relative", width: 64, height: 64, flexShrink: 0 }}>
                  ...
                  <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: "var(--font-dm-mono), monospace", fontSize: 20, fontWeight: 600, color: fitColor }}>{card.fit}%</span>
                  </div>
                </div>
                <div>
                  <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#1A1A1A", marginBottom: 2 }}>{card.fit >= 85 ? "Strong match" : card.fit >= 70 ? "Good fit" : "Fair match"}</p>
                  <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.5, textWrap: "pretty" }}>{job.fitSummary}</p>
                </div>
              </div>

              {/* Why you fit */}
              <div style={{ marginBottom: 14 }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#4A8B6A", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 8 }}>Why you fit</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {job.fitWorks.map((w, i) => (
                    <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", padding: "8px 10px", background: "rgba(74,139,106,0.06)", borderRadius: 7 }}>
                      <span style={{ color: "#4A8B6A", fontSize: 16, flexShrink: 0, marginTop: 1 }}>✓</span>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#2A2218", lineHeight: 1.5, textWrap: "pretty" }}>{w}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Watch outs */}
              <div style={{ marginBottom: 14 }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#C4A86A", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 8 }}>Watch outs</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  {job.fitWatches.map((w, i) => (
                    <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start", padding: "8px 10px", background: "rgba(196,168,106,0.06)", borderRadius: 7 }}>
                      <span style={{ color: "#C4A86A", fontSize: 16, flexShrink: 0, marginTop: 1 }}>△</span>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#2A2218", lineHeight: 1.5, textWrap: "pretty" }}>{w}</p>
                    </div>
                  ))}
                </div>
              ...
              {/* Gaps */}
              <div>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#C4574A", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 8 }}>Gaps to address</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                  {job.gaps.map((g, i) => (
                    <div key={i} style={{ padding: "10px 12px", background: "#FFFFFF", borderRadius: 7, borderLeft: "2px solid #C4574A" }}>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#1A1A1A", marginBottom: 3 }}>{g.title}</p>
                      <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.5, textWrap: "pretty" }}>{g.body}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ animation: "fadeIn 0.3s ease both" }}>
              {meta.description && (
                <div style={{ marginBottom: 18 }}>
                  ...
                  <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18, fontWeight: 300, color: "#2A2218", lineHeight: 1.7, textWrap: "pretty" }}>
                    {meta.description}
                  </p>
                </div>
              )}
              ...
              <div style={{ padding: "12px 14px", background: "rgba(196,168,106,0.08)", borderRadius: 7, borderLeft: "2px solid #C4A86A" }}>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 600, color: "#7A6020", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 4 }}>AI analysis</p>
                <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 16, fontWeight: 300, color: "#52493F", lineHeight: 1.55 }}>
                  Use the AI tools above to get a tailored resume update, cover letter, and fit analysis for this role.
                </p>
              </div>
            </div>
          ) : tool === null ? (
            <div style={{ padding: 24, textAlign: "center", color: "#A09890", fontFamily: "var(--font-dm-sans), system-ui", fontSize: 18 }}>
