      ...
      <div className="kimchi-chips__row">
        {chips.map((chip) => (
          ...
          >
            ...
            {inline && (
              <span className="kimchi-chips__sparkle" aria-hidden="true">✦</span>
            )}
...
function KimchiChipStyles() {
  return (
    <style>{`
      ...
      .kimchi-chips--inline .kimchi-chips__sparkle {
        flex-shrink: 0;
        font-size: 10px;
        line-height: 1;
        color: #E8913A;
      ...
      .kimchi-chips--inline .kimchi-chips__chip--action:hover,
