...
export function ImportAuditDetails({
  result,
  clientUserId,
  showVerifyLinks = true,
}: {
  ...
  return (
    <>
      <AuditList title="Target roles" added={audit.targetRoles.added} skipped={audit.targetRoles.skipped} />
      <AuditList title="Deprioritized roles" added={audit.deprioritizedRoles.added} skipped={audit.deprioritizedRoles.skipped} />
      <AuditList title="Keywords to use" added={audit.prioritizedCategories.added} skipped={audit.prioritizedCategories.skipped} />
      <AuditList title="Keywords to avoid" added={audit.deprioritizedCategories.added} skipped={audit.deprioritizedCategories.skipped} />
...
export function importResultHasChanges(result: ClientImportApplyResult): boolean {
  return (
