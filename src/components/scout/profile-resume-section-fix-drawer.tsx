    ...
    <>
      ...
      >
        <div style={{ padding: "14px 20px", borderBottom: `1px solid ${JR.border}`, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          {urgentCount > 0 && (
            <span style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "4px 10px", borderRadius: "var(--scout-radius)", background: JR.urgentBg, color: JR.urgent, fontSize: 12, fontWeight: 700 }}>
              ...
              issues.map((issue) => {
                ...
                return (
                  <div key={issue.id} style={{ marginBottom: 20 }}>
                    ...
                    <div style={{ background: "#FFF5F5", borderRadius: "var(--scout-radius)", padding: "18px 20px", border: `1px solid #FECACA` }}>
                      ...
                      <div style={{ marginTop: 16, paddingTop: 14, borderTop: `1px solid ${JR.border}`, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                        ...
                        <div style={{ display: "flex", gap: 8 }}>
                          <button type="button" style={{ background: JR.panel, border: `1px solid ${JR.border}`, borderRadius: "var(--scout-radius)", padding: "6px 10px", fontSize: 11, cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}>
