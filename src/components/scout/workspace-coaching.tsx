  ...
  if (!featured) {
    return (
      <div style={{ background: "#fff", borderRadius: 10, padding: 24, border: "1px solid rgba(0,0,0,0.06)" }}>
        <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 14, color: "#7A7268" }}>
  ...
  return (
    <div style={{ paddingBottom: 40 }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "flex-start", gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontFamily: "var(--font-dm-sans), system-ui", fontSize: 13, color: "#7A7268", marginTop: 2, marginBottom: 6 }}>
              {featured.currentRole}{featured.currentCompany ? ` · ${featured.currentCompany}` : ""}
            </p>
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              {featured.firms.slice(0, 2).map((f) => (
                <span key={f} style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, color: "#1A3A2F", fontWeight: 500 }}>{f}</span>
              ))}
              {featured.hourlyRate && (
                isPro
                  ? <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, color: "#1A3A2F", fontWeight: 500 }}>${featured.hourlyRate}/hr</span>
                  : <span onClick={onSubscribe} title="Subscribe to see rate" style={{ cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 3, userSelect: "none" }}>
                      <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 500, color: "#1A3A2F", filter: "blur(4px)", pointerEvents: "none" }}>${featured.hourlyRate}/hr</span>
                    </span>
              )}
              {featured.location && (
                <span style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, color: "#7A7268" }}>{featured.location}</span>
              )}
            </div>
          </div>
        </div>
        ...
        {featured.bio && (
          <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 300, color: "#52493F", lineHeight: 1.65, marginBottom: 16, textWrap: "pretty" } as React.CSSProperties}>
        ...
        {featured.specialties.length > 0 && (
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 16 }}>
            {featured.specialties.map((s) => (
              <span key={s} style={{ padding: "5px 12px", background: "rgba(26,58,47,0.06)", borderRadius: 100, fontFamily: "var(--font-dm-sans)", fontSize: 13, color: "#1A3A2F" }}>
                {s}
              </span>
            ))}
          </div>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          {isPro
            ? <button style={{ padding: "11px 22px", background: "#1A3A2F", color: "#E8D5A3", border: "none", borderRadius: 6, fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Book a session →</button>
            : <button onClick={onSubscribe} style={{ padding: "11px 22px", background: "#F2EDE3", color: "#7a7268", border: "1px solid rgba(0,0,0,0.12)", borderRadius: 6, fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>🔒 Subscribe to book</button>
          }
          {featured.linkedinUrl && (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              style={{ padding: "11px 18px", background: "transparent", color: "#1A3A2F", border: "1px solid rgba(26,58,47,0.2)", borderRadius: 6, fontFamily: "var(--font-dm-sans)", fontSize: 13, cursor: "pointer", textDecoration: "none", display: "flex", alignItems: "center" }}
            >
              LinkedIn ↗
            </a>
          )}
      ...
      <div style={{ background: "#FFFFFF", borderRadius: 10, padding: "18px 24px", border: "1px solid rgba(0,0,0,0.06)" }}>
        <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 11, fontWeight: 600, color: "#A09890", textTransform: "uppercase", letterSpacing: "1px", marginBottom: 10 }}>
          Upcoming sessions
        </p>
    ...
    <div style={{ paddingBottom: 40 }}>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16, flexWrap: "wrap" }}>
        ...
        <select
          ...
          style={{ padding: "10px 12px", border: "1px solid rgba(0,0,0,0.1)", borderRadius: 6, background: "#FFFFFF", fontFamily: "var(--font-dm-sans)", fontSize: 13, color: selectedFirm ? "#1A1A1A" : "#7A7268", cursor: "pointer" }}
        >
        ...
        <select
          ...
          style={{ padding: "10px 12px", border: "1px solid rgba(0,0,0,0.1)", borderRadius: 6, background: "#FFFFFF", fontFamily: "var(--font-dm-sans)", fontSize: 13, color: selectedSpecialty ? "#1A1A1A" : "#7A7268", cursor: "pointer" }}
        >
      ...
      <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, color: "#A09890", marginBottom: 14 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
                  <div>
                    <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 14, fontWeight: 600, color: "#1A1A1A" }}>
                      {c.displayName}{" "}
                      {c.featured && (
                        <span style={{ marginLeft: 6, padding: "1px 7px", background: "rgba(196,168,106,0.15)", borderRadius: 100, fontFamily: "var(--font-dm-sans)", fontSize: 11, color: "#7A6020", fontWeight: 600 }}>
                          Featured
                        </span>
                      )}
                    </p>
                  ...
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    {c.hourlyRate ? (
                      isPro
                        ? <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 14, fontWeight: 600, color: "#1A3A2F" }}>${c.hourlyRate}<span style={{ fontSize: 12, color: "#A09890", fontWeight: 400 }}>/hr</span></p>
                    ...
                    {c.location && (
                      <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 12, color: "#A09890" }}>{c.location}</p>
                    )}
                  </div>
                </div>

                {c.headline && (
                  <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 300, color: "#52493F", lineHeight: 1.55, marginBottom: 10, textWrap: "pretty" } as React.CSSProperties}>
                    {c.headline}
                  </p>
                )}
                ...
                {c.specialties.length > 0 && (
                  <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 10 }}>
                    {c.specialties.map((s) => (
                      <span key={s} style={{ padding: "4px 10px", background: "rgba(26,58,47,0.06)", borderRadius: 100, fontFamily: "var(--font-dm-sans)", fontSize: 12, color: "#1A3A2F" }}>
                        {s}
                      </span>
                    ))}
                  </div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
                  {c.firms.map((f) => (
                    <span key={f} style={{ fontFamily: "var(--font-dm-sans)", fontSize: 12, color: "#1A3A2F", fontWeight: 500 }}>{f}</span>
                  ))}
                  {c.firms.length > 0 && c.schools.length > 0 && <span style={{ color: "#d4cfc9", fontSize: 12 }}>·</span>}
                  {c.schools.slice(0, 2).map((s) => (
                    <span key={s} style={{ fontFamily: "var(--font-dm-sans)", fontSize: 12, color: "#A09890" }}>{s}</span>
                  ))}
                  {(c.linkedinUrl || c.lelandUrl) && <span style={{ color: "#d4cfc9", fontSize: 12 }}>·</span>}
                  {c.lelandUrl && (
                    <a href={c.lelandUrl} target="_blank" rel="noreferrer" style={{ fontSize: 12, color: "#4A8B6A", textDecoration: "none", fontFamily: "var(--font-dm-sans)" }}>
                      Leland ↗
                    </a>
                  )}
                  {c.linkedinUrl && (
                    <a href={c.linkedinUrl} target="_blank" rel="noreferrer" style={{ fontSize: 12, color: "#4A8B6A", textDecoration: "none", fontFamily: "var(--font-dm-sans)" }}>
                      LinkedIn ↗
                    </a>
                  )}
                  <span style={{ flex: 1 }} />
                  {isPro
                    ? <button style={{ padding: "8px 16px", background: "#1A3A2F", color: "#E8D5A3", border: "none", borderRadius: 6, fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>Book →</button>
                    : <button onClick={onSubscribe} style={{ padding: "8px 16px", background: "#F2EDE3", color: "#7a7268", border: "1px solid rgba(0,0,0,0.1)", borderRadius: 6, fontFamily: "var(--font-dm-sans)", fontSize: 13, fontWeight: 500, cursor: "pointer" }}>🔒 Book</button>
                  }
                </div>
              </div>
            </div>
