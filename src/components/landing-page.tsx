    ...
    <div style={{ background: "var(--scout-page)", minHeight: "100vh", fontFamily: "var(--font-ui), sans-serif" }}>
      ...
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 48px", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          ...
          <Link href="/signup" style={{ fontSize: 14, color: "var(--scout-cta-foreground)", background: "var(--scout-cta)", borderRadius: "var(--scout-radius)", padding: "9px 20px", textDecoration: "none", fontWeight: 500 }}>
            Get started free
          </Link>
        </div>
      </nav>
      ...
      <section style={{ maxWidth: 720, margin: "0 auto", padding: "96px 48px 80px", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/signup" style={{ fontSize: 15, fontWeight: 600, color: "var(--scout-cta-foreground)", background: "var(--scout-cta)", borderRadius: "var(--scout-radius)", padding: "14px 32px", textDecoration: "none", display: "inline-block" }}>
            Start for free
          </Link>
      ...
      <section style={{ maxWidth: 960, margin: "0 auto", padding: "0 48px 96px", display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
        {[
          ...
          <div key={f.title} style={{ background: "#FFFDF9", border: "1px solid #E5DDD0", borderRadius: "var(--scout-radius)", padding: "28px 28px 32px" }}>
      ...
      <section style={{ maxWidth: 640, margin: "0 auto", padding: "80px 48px 96px", textAlign: "center" }}>
        ...
        <Link href="/signup" style={{ fontSize: 15, fontWeight: 600, color: "var(--scout-cta-foreground)", background: "var(--scout-cta)", borderRadius: "var(--scout-radius)", padding: "14px 36px", textDecoration: "none", display: "inline-block" }}>
